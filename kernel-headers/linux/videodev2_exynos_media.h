...
#define SBWC_8B_STRIDE(w) (__ALIGN_UP((8 / 2) * SBWC_BLOCK_WIDTH, SBWC_PAYLOAD_STRIDE_ALIGN) * SBWC_H_BLOCKS(w))
#define SBWC_10B_STRIDE(w) (__ALIGN_UP((10 / 2) * SBWC_BLOCK_WIDTH, SBWC_PAYLOAD_STRIDE_ALIGN) * SBWC_H_BLOCKS(w))
#define SBWC_HEADER_STRIDE(w) (__ALIGN_UP(__COUNT_BLOCKS(w, SBWC_BLOCK_WIDTH * 2), SBWC_HEADER_STRIDE_ALIGN))
#define SBWC_Y_VSTRIDE_BLOCKS(h,a) __COUNT_BLOCKS(SBWC_ALIGNED_H(h, a), SBWC_BLOCK_HEIGHT)
#define SBWC_CBCR_VSTRIDE_BLOCKS(h,a) __COUNT_BLOCKS(SBWC_ALIGNED_H(h, a) / 2, SBWC_BLOCK_HEIGHT)
#define SBWC_8B_Y_SIZE(w,h) ((SBWC_8B_STRIDE(w) * SBWC_Y_VSTRIDE_BLOCKS(h, 16)) + 64)
#define SBWC_8B_CBCR_SIZE(w,h) ((SBWC_8B_STRIDE(w) * SBWC_CBCR_VSTRIDE_BLOCKS(h, 16)) + 64)
#define SBWC_8B_Y_HEADER_SIZE(w,h) ((SBWC_HEADER_STRIDE(w) * SBWC_Y_VSTRIDE_BLOCKS(h, 16)) + 256)
#define SBWC_8B_CBCR_HEADER_SIZE(w,h) ((SBWC_HEADER_STRIDE(w) * SBWC_CBCR_VSTRIDE_BLOCKS(h, 16)) + 128)
#define SBWC_10B_Y_SIZE(w,h) ((SBWC_10B_STRIDE(w) * SBWC_Y_VSTRIDE_BLOCKS(h, 8)) + 64)
#define SBWC_10B_CBCR_SIZE(w,h) ((SBWC_10B_STRIDE(w) * SBWC_CBCR_VSTRIDE_BLOCKS(h, 8)) + 64)
#define SBWC_10B_Y_HEADER_SIZE(w,h) ((SBWC_HEADER_STRIDE(w) * SBWC_Y_VSTRIDE_BLOCKS(h, 8)) + 256)
#define SBWC_10B_CBCR_HEADER_SIZE(w,h) ((SBWC_HEADER_STRIDE(w) * SBWC_CBCR_VSTRIDE_BLOCKS(h, 8)) + 128)
...
#define AFBC_8B_Y_SIZE(w,h) ((((((w) + 31) / 32) * (((h) + 7) / 8) * 16 + 127) / 128) * 128 + (((w) + 31) / 32) * (((h) + 7) / 8) * 384)
#define AFBC_10B_Y_SIZE(w,h) ((((((w) + 31) / 32) * (((h) + 7) / 8) * 16 + 127) / 128) * 128 + (((w) + 31) / 32) * (((h) + 7) / 8) * 512)
#endif
